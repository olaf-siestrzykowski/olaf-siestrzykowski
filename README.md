...
![My Skills](https://skillicons.dev/icons?i=py,postgres,mysql,git,github,django,css,html,js,flask,docker,nginx,heroku,postman,selenium,linux,bash,autocad&perline=5)
